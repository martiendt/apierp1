...
import { DeleteSupplierGroupRepository } from "../model/repository/delete.repository.js";
...
export class DeleteSupplierGroupUseCase {
  ...
  public async handle(id: string, options: DeleteOptionsInterface) {
    try {
      ...
      const response = await new DeleteSupplierGroupRepository(this.db).handle(id, options);
