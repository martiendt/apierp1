...
import { AllocationEntity } from "../model/allocation.entity.js";
import { UpdateAllocationRepository } from "../model/repository/update.repository.js";
...
export class UpdateAllocationUseCase {
  ...
  public async handle(id: string, document: DocumentInterface, options: UpdateOptionsInterface) {
    try {
      ...
      const allocationRepository = new UpdateAllocationRepository(this.db);
      await allocationRepository.handle(id, objClean(allocationEntity), {
