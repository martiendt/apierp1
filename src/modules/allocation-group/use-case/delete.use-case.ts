...
import { DeleteAllocationGroupRepository } from "../model/repository/delete.repository.js";
...
export class DeleteAllocationGroupUseCase {
  ...
  public async handle(id: string, options: DeleteOptionsInterface) {
    try {
      ...
      const response = await new DeleteAllocationGroupRepository(this.db).handle(id, options);
