...
import { DeleteExpeditionRepository } from "../model/repository/delete.repository.js";
...
export class DeleteExpeditionUseCase {
  ...
  public async handle(id: string, options: DeleteOptionsInterface) {
    try {
      ...
      const response = await new DeleteExpeditionRepository(this.db).handle(id, options);
