...
import { DeleteCustomerGroupRepository } from "../model/repository/delete.repository.js";
...
export class DeleteCustomerGroupUseCase {
  ...
  public async handle(id: string, options: DeleteOptionsInterface) {
    try {
      ...
      const response = await new DeleteCustomerGroupRepository(this.db).handle(id, options);
