...
import { CreateCustomerGroupRepository } from "../model/repository/create.repository.js";
...
export class CreateCustomerGroupUseCase {
  ...
  public async handle(document: DocumentInterface, options: CreateOptionsInterface) {
    try {
      ...
      // save to database
      const customerGroupEntity = objClean(
      ...
      const response = await new CreateCustomerGroupRepository(this.db).handle(customerGroupEntity, options);
